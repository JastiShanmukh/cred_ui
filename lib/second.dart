      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Container(
              width: width * 0.9,
              child: Text("give us your \nmobile number ",style: TextStyles.style2),
              ),
            SizedBox(height: height * 0.01),
            Container(
              width: width * 0.9,
              child: Text("to apply, we need your mobile\nnumber linked to your credit card",
            ...
            Container(
              width: width * 0.9,
              child: Text("9999999999",style: TextStyles.style4),
            ),
